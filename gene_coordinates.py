...
path_to_bio_mart = "../Raw Data/BioMart Gene Coordinates/Gene Coordinates.txt"
path_to_pickle = "../Raw Data/BioMart Gene Coordinates/gene_coordinates.pickle"
...
def gene_to_coord(gene):
    ...
    if gene in nameToOfficial and nameToOfficial[gene] in officialToCoord:
        return [True] + list(officialToCoord[nameToOfficial[gene]])
    else:
        return [False, -1, -1, -1]
