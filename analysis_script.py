...
for dataload_source, storageSpace in zip(
				...
				while s:
					...
					if isMalat:
						...
						if rbp not in malat1_storage: 
							malat1_storage[rbp] = BindingSites(overlap_mode=True)
						...
						if rbp not in neat1_storage: 
							neat1_storage[rbp] = BindingSites(overlap_mode=True)
	...
	storageSpace['Neat1'] = neat1_storage
	storageSpace['Malat1'] = malat1_storage
